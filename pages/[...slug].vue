...
useHead({
  title: page.value?.title || "Douglas Ochner",
  meta: [
    { property: "og:title", content: page.value?.title || "Douglas Ochner" },
    ...
    ...(page.value?.image
      ? [
          {
            property: "og:image",
            content: new URL(page.value.image, domain).toString(),
          },
        ]
      : []),
  ...
  <div class="document-driven-page">
    <NuxtLayout :name="layout || 'default'">
      <div v-if="page">
        ...
        <div
          v-if="$route.path !== '/'"
          class="max-w-screen-md m-auto mt-8 mb-8"
        >
          <NuxtLink
